"""
Reproducible entry point for the TAP-E3 experiment. Deterministic and offline.
...
from truth_assurance_pipeline.tap_e3_relationship_truth import harness
...
def main() -> None:
    ...
    with open(os.path.join(_HERE, "results_v3.json"), "w") as fh:
    ...
    print("wrote results_v3.json and experiment_lock.json")
