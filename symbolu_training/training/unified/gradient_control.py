"""
Gradient control utilities for unified LLM training.

Contains HierarchicalGradientScaler for Formula [1331] gradient dampening
and WeightTransfer for 9:3 -> 6:6 dynamic relaxation weight management.
"""
