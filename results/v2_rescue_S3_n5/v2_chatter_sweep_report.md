...
Scenario: `S3_map_error_accel`  ·  N = 5  ·  V2 thresholds engage/disengage = 0.5/0.2  ·  T_engage/T_disengage = 3/5

## Chatter reduction

- Median V1 argmax-flip rate: **0.7995**
- Median V2 argmax-flip rate: **0.7970**
- Median per-seed reduction: **0.0%**
- Per-seed V2-wins-on-flip-rate: **2/5** (40.0%)
