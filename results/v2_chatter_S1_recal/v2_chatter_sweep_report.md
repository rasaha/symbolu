...
Scenario: `S1_normal_driving`  ·  N = 3  ·  V2 thresholds engage/disengage = 0.01/0.005  ·  T_engage/T_disengage = 3/5

## Chatter reduction

- Median V1 argmax-flip rate: **0.7688**
- Median V2 argmax-flip rate: **0.7739**
- Median per-seed reduction: **0.5%**
- Per-seed V2-wins-on-flip-rate: **2/3** (66.7%)
