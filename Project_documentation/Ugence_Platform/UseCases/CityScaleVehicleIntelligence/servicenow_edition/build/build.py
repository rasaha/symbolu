...
BASE='UGENCE_CITY_SCALE_VEHICLE_INTELLIGENCE_SERVICENOW_INTEGRATION_EDITION_v1.1'
META=dict(
 title='Ugence + ServiceNow for City-Scale Vehicle Intelligence — Proposed Product Integration Architecture, Governed Workflows and Execution-Assurance Case Study',
 author='Ugence Labs',
 company='Ugence Labs',
 subject='PROPOSED Ugence–ServiceNow integration architecture and illustrative case study for governing city-scale vehicle intelligence; no Ugence ServiceNow connector currently ships',
 keywords='Ugence, ServiceNow, PROPOSED integration, vehicle intelligence, ANPR, Public Sector Digital Services, AI Control Tower, AI Action Fabric, IRM, ActionGate, Risk Authority, execution assurance, smart city')
...
@page { size:A4 portrait; margin:20mm 17mm 16mm 17mm;
 @top-left{ content:"Ugence + ServiceNow · City-Scale Vehicle Intelligence"; font:8pt Arial; color:#5b6472;}
 @top-right{ content:"Proposed Integration Edition · v1.1"; font:8pt Arial; color:#5b6472;}
 @bottom-left{ content:"Ugence Labs · ugence.ai"; font:8pt Arial; color:#5b6472;}
...
'''
    ...
    <div style="font:11pt Arial; letter-spacing:2px; color:#9aa0d8; text-transform:uppercase;">Ugence Labs · ServiceNow Integration Edition</div>
    <div style="height:14mm"></div>
    <div style="font-family:Georgia,serif; font-size:32pt; font-weight:bold; line-height:1.08;">Ugence + ServiceNow for<br>City-Scale Vehicle Intelligence</div>
    <div style="height:6mm"></div>
    <div style="font-family:Georgia,serif; font-size:16pt; color:#ECEAFB;">Proposed Product Integration Architecture, Governed Workflows and Execution-Assurance Case Study</div>
    <div style="height:12mm"></div>
    <div style="font-size:12pt; color:#c9cfea; max-width:154mm; line-height:1.5;">The vehicle-intelligence platform determines what the evidence indicates. ServiceNow manages the enterprise records, workflows, cases, policies, assets, AI governance and coordination. Ugence composes with ServiceNow as an independently verifiable action-level authority and execution-assurance service.</div>
    <div style="height:16mm"></div>
    <div style="font-size:13pt;"><strong style="color:#fff;">Prepared by Ugence Labs</strong></div>
    <div style="font-size:11.5pt; color:#c9cfea;">ugence.ai · Integration Edition v1.1 · ServiceNow research 15 August 2026</div>
    <div style="height:14mm"></div>
    <div style="font-size:9.5pt; font-style:italic; color:#f0c9b0; max-width:158mm; line-height:1.5;">PROPOSED SERVICENOW INTEGRATION — no Ugence ServiceNow connector currently ships. Illustrative, technically realistic composition; not a deployed customer integration, a certified ServiceNow application, a Store listing, a completed joint product, or ServiceNow endorsement. Not legal advice. ServiceNow capabilities are cited from official sources; verify on the live documentation before customer use.</div>
    </section>''')
    # TOC
...
def render_docx():
    ...
    hp=sec.header.paragraphs[0]; hp.text=''; r=hp.add_run('Ugence + ServiceNow for City-Scale Vehicle Intelligence — Proposed Integration Edition')
    r.font.size=Pt(8); r.font.color.rgb=RGBColor(0x5b,0x64,0x72)
    fp=sec.footer.paragraphs[0]; fp.text=''
    fr=fp.add_run('Ugence Labs · ugence.ai · Proposed Integration Edition v1.1      Page '); fr.font.size=Pt(8); fr.font.color.rgb=RGBColor(0x5b,0x64,0x72)
    ...
    cover_par('UGENCE LABS · SERVICENOW INTEGRATION EDITION',10,RGBColor(0x51,0x45,0xC7),bold=True,after=10)
    cover_par('Ugence + ServiceNow for City-Scale Vehicle Intelligence',28,NAVY,bold=True,after=6)
    cover_par('Proposed Product Integration Architecture, Governed Workflows and Execution-Assurance Case Study',15,VIOL,bold=True,after=12)
    cover_par('The vehicle-intelligence platform determines what the evidence indicates. ServiceNow manages the enterprise records, workflows, cases, policies, assets, AI governance and coordination. Ugence composes with ServiceNow as an independently verifiable action-level authority and execution-assurance service.',12,RGBColor(0x37,0x41,0x51),after=16)
    cover_par('Prepared by Ugence Labs',13,NAVY,bold=True,after=1)
    cover_par('ugence.ai · Integration Edition v1.1 · ServiceNow research 15 August 2026',11,RGBColor(0x37,0x41,0x51),after=16)
    cover_par('PROPOSED SERVICENOW INTEGRATION — no Ugence ServiceNow connector currently ships. Illustrative, technically realistic composition; not a deployed integration, a certified ServiceNow application, a Store listing, a completed joint product, or ServiceNow endorsement. Not legal advice. Verify ServiceNow capabilities on the live documentation before customer use.',9.5,GREY,italic=True,after=2)
    doc.add_page_break()
    # ---- TOC ----
