...
|---|---|---|
| ADR-0001 | The contract that declares CTM+ the spec and forbids a bridge | [`Project_documentation/repository/docs/design/ADR-0001-CTM-KV-SCORING-SOURCE-OF-TRUTH.md`](../../../../repository/docs/design/ADR-0001-CTM-KV-SCORING-SOURCE-OF-TRUTH.md) |
