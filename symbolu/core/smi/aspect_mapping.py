...
Usage:
    from symbolu.core.smi.aspect_mapping import AspectMapper
...
from symbolu.core.smi.smi_engine import get_ontology_level
from symbolu.core.constants import ONTOLOGICAL_LAYERS
