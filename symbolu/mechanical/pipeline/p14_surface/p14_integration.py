...
from symbolu.mechanical.pipeline.p14_surface.p14_surface_schema import (
    SurfaceStyle,
    PunctuationPolicy,
    HedgePolicy,
    LengthPolicy,
...
from symbolu.mechanical.pipeline.p14_surface.p14_surface_realizer import (
    P14SurfaceRealizer,
)
...
def get_forbidden_tokens(ctx: Any) -> Tuple[str, ...]:
    ...
    plan = get_p14_surface_plan(ctx)
    if plan is None:
        from symbolu.mechanical.pipeline.p14_surface.p14_surface_schema import DEFAULT_FORBIDDEN_TOKENS
