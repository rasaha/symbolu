...
Usage:
    ...
    from symbolu.presentation.acoustic_chain import AcousticGovernanceChain
...
from symbolu.presentation.p6_lite import P6LiteResolver
from symbolu.presentation.p7_lite import P7LiteResolver
...
from symbolu.mechanical.pipeline.p12_consistency.p12_consistency_schema import (
    P12ConsistencyReport,
    ViolationSeverity,
)
from symbolu.mechanical.pipeline.p12_consistency.p12_consistency_validator import (
...
def run_acoustic_chain(directive: PresentationDirective) -> AcousticChainResult:
    ...
    Example:
        >>> from symbolu.presentation.acoustic_chain import run_acoustic_chain
