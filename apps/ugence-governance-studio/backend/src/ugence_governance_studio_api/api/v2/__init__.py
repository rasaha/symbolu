...
FD-12) and the Vendor-dependency screen (front-door seam 9, FD-13), one router each. Every route is POST-for-evaluation or GET-for-read, and
...
__all__ = ["ROUTERS", "registry", "data_use", "vendor", "constitution", "policy", "authority", "simulate", "publish",
           "observe", "review"]
