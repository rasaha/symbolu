...
| `da` | ★ | Krodha / Karkaśatā (bi… | **P** | name+def | peevishness / reactive irritability — perver… | forbearance that absorbs provocation — an ev… |
...
| `la` | ★ | Krūratā (binding) | **P** |  | kruratā — cruelty: physical harm inflicted o… | compassion (karuṇā) that protects the vulner… |
| `ma` | ★ | Praśraya / Praṇāśa (bi… | **P** | name+def | praśraya / praṇāśa — giving latitude to the … | disciplined containment that holds form — la… |
