...
**Both arms CLOSED 2026-09-04** (owner instruction; see BTRR_SMOKE_CALIBRATION_LOG.md). `guard_seed` refuses all
reserved BTRR seeds. F13 and F16 are the generator state of the closure record (owner-closed on that record).
