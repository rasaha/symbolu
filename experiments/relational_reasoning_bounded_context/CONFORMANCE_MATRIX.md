...
## Post-smoke corrections (F11–F15)
| Finding | Correction | Test evidence | Status |
|---|---|---|---|
...
## Test totals
`tests/test_btrr.py` 28 + `tests/test_corrections.py` 25 + `tests/test_auth_mechanism.py` 12 + `tests/test_harness.py` 9 = **74 tests, all passing** (stdlib runner; no
