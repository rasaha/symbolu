...
Running the Server:
    from symbolu_core.service.api_server import create_app
    import uvicorn
...
from symbolu_core.service.request_models import (
    AnalyzeRequest,
    DILchatAPIResponse,
    UnifiedAPIResponse,
...
from symbolu_core.service.security.api_key_auth import verify_api_key
from symbolu_core.service.security.rate_limiter import enforce_rate_limit
...
def create_app() -> "FastAPI":
    ...
    def set_user_preference(req: UserPreferenceUpdate, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            from symbolu_core.service.preferences import get_preference_store, UserPreference
            from agentic.policy.interaction_modes import _parse_interaction_mode
    ...
    def set_admin_preference(req: AdminPreferenceUpdate, request: Request) -> Dict[str, Any]:
        ...
        try:
            ...
            # Import preference store and interaction modes
            from symbolu_core.service.preferences import get_preference_store, AdminPreference
            from agentic.policy.interaction_modes import _parse_interaction_mode
    ...
    def demo_name_analyze(req: NameAnalyzeRequest) -> Dict[str, Any]:
        ...
        try:
            ...
            from symbolu_core.name_resonance import analyze_name
    ...
    def demo_name_compare(req: NameCompareRequest) -> Dict[str, Any]:
        ...
        try:
            # Import name resonance API
            from symbolu_core.name_resonance import get_profile, compare_names
            from symbolu_core.name_resonance.types import DIMENSION_NAMES
    ...
    def demo_name_quick_match(req: QuickMatchRequest) -> Dict[str, Any]:
        ...
        try:
            # Import name resonance API
            from symbolu_core.name_resonance import analyze_name, quick_match
    ...
    async def chat_endpoint(req: ChatRequest, request: Request) -> Dict[str, Any]:
        ...
        try:
            # Import chat service
            from symbolu_core.service.chat_service import ChatService, ChatMessage
            ...
            usage_stats = None
            try:
                from symbolu_core.service.usage_tracker import get_usage_tracker
    ...
    def get_chat_providers(request: Request) -> Dict[str, Any]:
        ...
        try:
            from agentic.llm.providers import (
                LLMClient,
                ANTHROPIC_MODELS,
                GOOGLE_MODELS,
    ...
    def get_pricing_info() -> Dict[str, Any]:
        ...
        """
        from symbolu_core.service.usage_tracker import COST_PER_MILLION
    ...
    async def generate_video(req: VideoGenerateRequest, request: Request) -> Dict[str, Any]:
        ...
        try:
            from symbolu_core.service.video_gen import RemotionVideoService
            from symbolu_core.service.video_gen.service import VideoGenerationRequest
