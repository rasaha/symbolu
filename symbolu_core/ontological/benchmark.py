...
from symbolu_core.ontological.engine import OntologicalEngine, create_engine
from symbolu_core.ontological.bhava import BhavaComputer90, summarize_bhava_structure
from symbolu_core.ontological.heads import MultiTaskHead
from symbolu_core.ontological.data_loader import RAGDataLoader, SyntheticDataGenerator
from symbolu_core.ontological.types import LAYER_NAMES, TrainingExample
from symbolu_core.ontological.trainer import OntologicalTrainer, TrainerConfig
...
def benchmark_bhava_relationships() -> BenchmarkResult:
    ...
    for text, expected_blend in test_samples:
        ...
        from symbolu_core.ontological.bhava import BHAVA_NAMES_90
