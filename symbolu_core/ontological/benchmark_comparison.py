...
def benchmark_encoder(encoder_type: str = "hash") -> EncoderBenchmarkResult:
    ...
    """
    from symbolu_core.ontological.encoder import get_encoder, HashEncoder, SentenceTransformerEncoder
    from symbolu_core.ontological.engine import create_engine
