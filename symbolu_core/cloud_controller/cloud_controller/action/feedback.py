...
from symbolu_core.cloud_controller.action.outcome import OutcomeRecord, OutcomeVerdict
from symbolu_core.cloud_controller.action.rollback import RollbackWatch, RollbackVerdict
...
def _ensure_divergence_types():
    ...
    if not _divergence_types_loaded:
        from symbolu_core.cloud_controller.shadow.divergence import Verdict, DivergenceRecord
        _Verdict = Verdict
