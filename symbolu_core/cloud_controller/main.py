...
Usage:
    python -m symbolu.cloud_controller.main --config /etc/ncc/controller.yaml
    python -m symbolu.cloud_controller.main --dry-run          # defaults, no scaling
    python -m symbolu.cloud_controller.main --shadow           # shadow mode vs HPA
"""
...
from symbolu_core.cloud_controller.config import InfraControllerConfig
from symbolu_core.cloud_controller.controller import Controller
from symbolu_core.cloud_controller.observability.exporter import (
    ExporterConfig,
    ExporterMode,
)
from symbolu_core.cloud_controller.observability.metrics_server import MetricsServerConfig
from symbolu_core.cloud_controller.observability.otel_exporter import OtelExporterConfig
from symbolu_core.cloud_controller.orchestrator import (
    OrchestratorConfig,
    ProductionOrchestrator,
)
from symbolu_core.cloud_controller.signals.pipeline import PipelineConfig
from symbolu_core.cloud_controller.signals.prometheus import PrometheusConfig
from symbolu_core.cloud_controller.recommend.engine import RecommendConfig
from symbolu_core.cloud_controller.recommend.confidence import ConfidenceConfig
from symbolu_core.cloud_controller.recommend.safety import SafetyConfig
from symbolu_core.cloud_controller.action.k8s_actuator import ActuatorConfig, ActuatorMode
from symbolu_core.cloud_controller.action.feedback import FeedbackConfig
...
def _run_shadow(config: Dict[str, Any], args: argparse.Namespace) -> None:
    ...
    from symbolu_core.cloud_controller.shadow.runner import ShadowConfig, ShadowRunner
