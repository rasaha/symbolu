...
from symbolu_core.presentation.signals import (
    VrittiDistribution,
    SessionContext,
    SignalBundle,
    V27ExperimentalSignals,
)
from symbolu_core.presentation.config import (
    PresentationConfig,
    PresentationTier,
...
from symbolu_core.presentation.engine import PresentationEngine
from symbolu_core.presentation.session import SessionStateManager
from symbolu_core.presentation.p6_lite import (
    P6LiteResolver,
    derive_regime,
    DELIVERY_MODE_TO_REGIME,
)
from symbolu_core.presentation.p7_lite import (
    P7LiteResolver,
    derive_discourse_act,
    DELIVERY_MODE_TO_DISCOURSE_ACT,
)
from symbolu_core.presentation.acoustic_chain import (
    AcousticGovernanceChain,
    AcousticChainResult,
    run_acoustic_chain,
    is_acoustically_consistent,
)
from symbolu_core.presentation.prosodic_renderer import (
    ProsodicRenderer,
    SSMLOutput,
    ProsodyLevel,
    render_ssml,
...
from symbolu_core.presentation.speech_pipeline import (
    SpeechPipeline,
    SpeechOutput,
    PipelineMode,
    generate_speech,
...
from symbolu_core.presentation.signal_bridge import (
...
from symbolu_core.presentation.response_renderer import (
    ResponseRenderer,
    RenderedResponse,
    ResponseSection,
    render_response,
...
from symbolu_core.presentation.pipeline import (
