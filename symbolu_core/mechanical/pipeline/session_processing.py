...
def _process_session_recap(
    ...
    try:
        from symbolu_core.service.sessions import compute_session_summary
        from symbolu_core.service.sessions.session_summarizer import compute_session_recap
...
def _process_identity_signature(
    ...
    try:
        from agentic.identity.identity_signature_engine import compute_identity_signature
