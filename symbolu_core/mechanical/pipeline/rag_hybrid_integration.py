...
if TYPE_CHECKING:
    from symbolu_core.rag import CandidateEntry
    from symbolu_core.mechanical.fusion.schemas.candidate import Candidate
...
try:
    from symbolu_core.hybrid.prefilter import CandidatePreFilter, FilterStats
    HAS_PREFILTER = True
except ImportError:
    HAS_PREFILTER = False

try:
    from symbolu_core.hybrid.attention import PhonemeAttentionHead
    HAS_ATTENTION = True
except ImportError:
    HAS_ATTENTION = False
...
try:
    from symbolu_core.resonance import analyze_phrase, PhraseAnalysis
    HAS_RESONANCE = True
except ImportError:
    HAS_RESONANCE = False
