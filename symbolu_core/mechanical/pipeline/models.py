...
if TYPE_CHECKING:
    from agentic.core.coherence import CoherenceState
    ...
    from symbolu_core.mechanical.pipeline.p8_semantics.p8_semantic_schema import SemanticFrame
    ...
    from symbolu_core.mechanical.pipeline.p11_prosodic.p11_prosodic_schema import ProsodicEvidenceFrame
    from symbolu_core.mechanical.pipeline.p12_consistency.p12_consistency_schema import P12ConsistencyReport
    from symbolu_core.mechanical.pipeline.p13_acoustic_safety.p13_acoustic_safety_schema import AcousticSafetyEnvelope
    from symbolu_core.mechanical.pipeline.p14_surface.p14_surface_schema import SurfacePlan
    from symbolu_core.mechanical.pipeline.p15_interaction.p15_interaction_schema import InteractionDirective
    from symbolu_core.mechanical.pipeline.p17_semantic_integrity.p17_schema import P17IntegrityReport
    from symbolu_core.mechanical.pipeline.p18_temporal_entropy.p18_schema import P18TemporalEntropyReport
    from symbolu_core.mechanical.pipeline.p20_snapshot.p20_unified_snapshot_schema import UnifiedCognitiveSnapshot
    from symbolu_core.mechanical.pipeline.p24_projection.p24_projection_schema import P24ProjectionReport
    from agentic.core.counterfactual.cf_schema import CounterfactualSandboxReport
    from symbolu_core.mechanical.pipeline.p33_schema_adaptive.p33_schema_snapshot import SchemaAdaptiveRoutingSnapshot
    from agentic.core.predictive.persona_drift.drift_report import PredictivePersonaDriftReport
    from agentic.policy.insight_window.insight_envelope import InsightWindowEnvelope
    from symbolu_core.mechanical.pipeline.p41_scenario_regime_mapper.p41_schema import ScenarioRegimeMap
    from symbolu_core.mechanical.pipeline.p52_governance_adapter.p52_schema import GovernanceRequest
