...
Usage:
    from symbolu_core.mechanical.pipeline.p40_cross_horizon_alignment import maybe_run_p40
...
from symbolu_core.mechanical.pipeline.p40_cross_horizon_alignment.p40_resolver import (
    clamp,
...
from symbolu_core.mechanical.pipeline.p40_cross_horizon_alignment.p40_integration import (
    maybe_run_p40,
    run_p40_directly,
    is_p40_disabled,
    has_p40_alignment,
