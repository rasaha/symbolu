...
Usage in orchestrator:
    from symbolu_core.mechanical.pipeline.p10_acoustic.p10_gcc_integration import (
...
from symbolu_core.mechanical.pipeline.p10_acoustic.p10_gcc_mode import (
    GCCMode,
    Phase10Request,
    Phase10Response,
)
from symbolu_core.mechanical.pipeline.p10_acoustic.p10_gcc_resolver import (
    GCCLedgerEntry,
    P10GCCResolver,
    compute_gcc_span_id,
    compute_layers_hash,
...
def maybe_run_p10_gcc(
    ...
    from agentic.ontology.router.ontological_router_r1 import OntologicalLayer
