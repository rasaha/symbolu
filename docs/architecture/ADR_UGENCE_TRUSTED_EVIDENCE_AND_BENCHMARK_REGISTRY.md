...
Thirty-five owner decisions, **D-01 through D-35**, all ratified — nineteen at
the original ratification (D-01–D-19) and sixteen added by later amendment.
...
`BR-2C-0` at `0.2.1`, meaning *BR-2C's contract surface landed; no BR-2C
...
awaits BR-2D. **Three further questions the BR-2C contract slice left
open are ruled by D-33 (the version ladder), D-34 (the anchor-resolution seam)
and D-35 (which refusals a verified result may carry); none of the three touches
