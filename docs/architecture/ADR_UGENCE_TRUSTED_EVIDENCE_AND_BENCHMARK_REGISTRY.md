...
Thirty-six owner decisions, **D-01 through D-36**, all ratified — nineteen at
the original ratification (D-01–D-19) and seventeen added by later amendment.
...
D-36**, and the rows are not swept when code moves.
...
Two deliberate exceptions, both re-verified against the tree at the pass that
wrote them: **D-33**'s and **D-36**'s citations, because those rows turn on
