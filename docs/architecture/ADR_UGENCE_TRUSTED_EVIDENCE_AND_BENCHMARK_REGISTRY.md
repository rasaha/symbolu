...
Thirty-eight owner decisions, **D-01 through D-38**, all ratified — nineteen at
the original ratification (D-01–D-19) and nineteen added by later amendment.
...
D-38, without exception**, and the rows are not swept when code moves.
