...
ratified and implemented* above; **for OD-7 through OD-10, no guard exists**, on the terms recorded
...
(their prospective guards are `I8.12`–`I8.15` in the specification); and **S1 production implementation
