"""Verification guard. Fails on drift of ANY prior outcome-bearing artifact this readiness track must
not modify: the five completed research tracks (17 artifacts) PLUS the completed governed_inference_pilot
frozen baseline (4 artifacts) at ab237af. This track consumes governed_inference_pilot and all
components READ-ONLY; it modifies no frozen logic or artifact. Run in CI/tests before any outcome-bearing
comparison.
"""
...
FROZEN = {
    # five completed research tracks
    ...
    # governed_inference_pilot frozen baseline (ab237af)
