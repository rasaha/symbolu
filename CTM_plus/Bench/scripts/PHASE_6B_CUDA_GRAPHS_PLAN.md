...
| Phase 6E — Writer op fusion (CUDA) | SCOPED — design + 2 fused CUDA kernels to collapse the writer op chain. Projected: cap/bf16 0.30× → ~0.45-0.50× at B=8. ~7 days CUDA dev. | `PHASE_6E_WRITER_FUSION_DESIGN.md` |
