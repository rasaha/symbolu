...
from cloud_controller.observability.metrics_server import MetricsServerConfig
from cloud_controller.observability.otel_exporter import OtelExporterConfig
from cloud_controller.orchestrator import (
    OrchestratorConfig,
...
from cloud_controller.recommend.engine import RecommendConfig
from cloud_controller.recommend.confidence import ConfidenceConfig
from cloud_controller.recommend.safety import SafetyConfig
from cloud_controller.action.k8s_actuator import ActuatorConfig, ActuatorMode
from cloud_controller.action.feedback import FeedbackConfig
...
def _run_shadow(config: Dict[str, Any], args: argparse.Namespace) -> None:
    ...
    from cloud_controller.shadow.runner import ShadowConfig, ShadowRunner
