"""Shared fixtures for the procurement reference-domain tests."""

from __future__ import annotations

import pytest

from applications.procurement import ProcurementConfiguration, build_in_memory_platform
from applications.procurement.api import ProcurementAPI
from domains.procurement.requests import (
    BudgetReference,
    PurchaseItem,
    PurchaseRequest,
    SupplierReference,
