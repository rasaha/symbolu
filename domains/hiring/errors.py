...
The hiring domain's typed error families live physically in ``ai_hiring.errors``
...
code, mirroring the ``applications.ai_hiring`` / ``domains.hiring`` package
...
kernel (``decision_governance.errors``).

Identity is preserved: every name below is the *same class object* as the one
under ``ai_hiring.errors`` and, for the base, ``decision_governance.errors``.
