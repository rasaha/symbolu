...
belong to the kernel — import those from ``decision_governance.repositories``,
not here.

The implementations live physically under ``ai_hiring.repositories`` (retained
...
from ai_hiring.repositories.in_memory import (
...
from ai_hiring.repositories.evidence_artifacts import (
    InMemoryChunkRepository,
    InMemoryLineageRepository,
    InMemoryProvenanceRepository,
    InMemoryQuarantineRepository,
)
from ai_hiring.repositories.evidence_index_repository import (
    InMemoryEvidenceIndexRepository,
)
from ai_hiring.repositories.ontology_repository import InMemoryOntologyRepository
from ai_hiring.repositories.rubric_repository import InMemoryRubricRepository
from ai_hiring.repositories.assessment_repository import InMemoryAssessmentRepository
from ai_hiring.repositories.assessment_workspace_repository import (
