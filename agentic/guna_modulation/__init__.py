...
- agentic/inference/guna_inference.py computes token-level guna approximations
...
Usage:
    from agentic.guna_modulation import (
...
from agentic.guna_modulation.pipeline_integration import (
    # Result type
...
from agentic.guna_modulation.pipeline_signal_adapter import (
    # Intent mapping
...
from agentic.guna_modulation.observables import (
...
from agentic.guna_modulation.state_evolution_engine import (
    # Audit types
    RuleFired,
    StateUpdateAudit,
    # Engine
...
from agentic.guna_modulation.experimental_reasoning import (
    # DPO
    PreferenceGoal,
    PreferencePair,
    DPOConfig,
...
from agentic.guna_modulation.causal_layer import (
    # Constants
    LAYER_CAUSAL_ORDER,
    LAYER_POSITION,
    # Graph utilities
