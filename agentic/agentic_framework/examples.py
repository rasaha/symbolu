...
def example_gemini_basic():
    ...
    """
    from agentic.agentic_framework import AgenticLLMWrapper
    from agentic.agentic_framework.llm_adapters import GeminiAdapter
...
def example_production_config():
    ...
    """
    from agentic.agentic_framework import AgenticLLMWrapper
    from agentic.agentic_framework.reflective_loop import HybridCritic
    from agentic.agentic_framework.safety_contract import create_default_evaluator
    from agentic.agentic_framework.llm_adapters import MockLLMAdapter
...
def example_separate_critic_llm():
    ...
    """
    from agentic.agentic_framework import AgenticLLMWrapper
    from agentic.agentic_framework.reflective_loop import LLMBasedCritic
    from agentic.agentic_framework.llm_adapters import MockLLMAdapter
