...
from agentic.agentic_framework.external_actions import (
    ActionStatus,
    GateOutcome,
    ExecutionResultCode,
    Reversibility,
...
__all__ = [
    ...
    "ReviewManager",
    "format_review_trace",
    # H20 — governed external actions & resource state
    "ActionStatus",
    "GateOutcome",
    "ExecutionResultCode",
    "Reversibility",
...
__version__ = "1.20.0"  # + H20 governed external actions, resource state & durable execution
