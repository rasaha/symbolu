...
from agentic.temporal.cross_domain_intelligence import (
    CrossDomainIntelligence,
    PatternConfig,
)
from agentic.temporal.pattern_sequence_rules import (
    PATTERN_SEQUENCES,
    PatternSequenceRule,
)
from agentic.temporal.pattern_aspect_derivation import derive_aspect_vector
