...
Usage:
    from agentic.core.continuity import (
...
from agentic.core.continuity.continuity_models import (
    # Version
    P37_VERSION,
    # Constants
    W_PERSISTENCE,
...
from agentic.core.continuity.adaptive_continuity_engine import (
    # Helpers
    clamp,
    safe_get,
    # Core formulas
