...
from agentic.entropy.guna_entropy import compute_guna_entropy
from agentic.entropy.kosha_entropy import compute_kosha_entropy
...
def create_engine_for_tier(tier_name: str) -> EntropyEngine:
    ...
    """
    from agentic.entropy.config import get_tier_config
