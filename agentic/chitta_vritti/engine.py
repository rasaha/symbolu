...
from agentic.chitta_vritti.coherence import (
    CoherenceComputer,
    quick_opposition_check,
)
from agentic.chitta_vritti.vritti import VrittiComputer, get_dominant_vritti
from agentic.chitta_vritti.score import compute_score
from agentic.chitta_vritti.explain import generate_brief_explanation
...
def create_engine(
    ...
    Returns:
        Configured engine
    """
    from agentic.chitta_vritti.types import CONSUMER_CONFIG, ENTERPRISE_CONFIG
