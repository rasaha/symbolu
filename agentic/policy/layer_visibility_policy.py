...
from agentic.ontology.layers.ontology_layer import GATED_LAYERS, OntologicalLayer
from agentic.ontology.contracts.projection_contract import ProjectionResponse
