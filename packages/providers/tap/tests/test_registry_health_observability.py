...
from ugence_tap_provider.health import check as health_check
from ugence_tap_provider.observability import TapInvocationLog
...
def test_duplicate_and_ambiguous_default_rejected():
    from ugence_governance_provider_framework.api import ProviderRegistrationError
    reg = ProviderRegistry()
