"""Request/result/constraint mapping + error translation (canonical)."""
...
from ugence_actiongate_provider.core import (
    ActionGateConstraint, ActionGateDecision, ActionGateEngine, ActionGateError,
    ActionGateObligation, ActionGateOutcome, ConstrainedRule)
