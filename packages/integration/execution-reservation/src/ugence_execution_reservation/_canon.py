...
Mirrors the repository's established pattern: sorted-key compact JSON, SHA-256,
UTC-normalized instants, and a hard refusal of naive datetimes. No clock is read
anywhere in this package; every instant is a caller input.
"""
...
_NAMESPACE = "execution_reservation"
_US = "\x1f"
...
def domain_digest(domain: str, payload: Any) -> str:
    """Domain-separated SHA-256 in the same preimage shape Action Clearance uses."""
