...
import ugence_data_use_admission as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-data-use-admission",
        "namespace": "ugence_data_use_admission",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_data_use_admission",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_data_use_admission.__all__). tests/packaging/test_packaging.py asserts "
