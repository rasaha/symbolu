...
import ugence_authority_directory as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-authority-directory",
        "namespace": "ugence_authority_directory",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_authority_directory",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_authority_directory.__all__). tests/packaging/test_packaging.py asserts "
