...
import ugence_approval_workflow as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-approval-workflow",
        "namespace": "ugence_approval_workflow",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_approval_workflow",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_approval_workflow.__all__). tests/packaging/test_packaging.py asserts "
