...
Mirrors the shape of ``ugence_execution_reservation._canon`` — copied, never
imported: sorted-key compact JSON, SHA-256, UTC-normalized instants, and a hard
refusal of naive datetimes. No clock is read anywhere in this package; every
instant is a caller input.
"""
...
def domain_digest(domain: str, payload: Any) -> str:
    """Domain-separated SHA-256 in the same preimage shape the sibling ledger uses."""
