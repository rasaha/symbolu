...
import ugence_change_effect_records as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-change-effect-records",
        "namespace": "ugence_change_effect_records",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_change_effect_records",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_change_effect_records.__all__). tests/packaging/test_packaging.py asserts "
