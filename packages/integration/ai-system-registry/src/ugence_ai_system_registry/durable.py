...
#: rather than a waiting room. This package is the reason the ruling was cheap: its
#: derived id does not carry the vocabulary, so a migrated registration would collide
#: with the record it migrates, and D-3 refuses a supersession binding the same system
#: identity — which a migration always does.
