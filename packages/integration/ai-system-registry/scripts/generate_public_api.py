...
import ugence_ai_system_registry as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-ai-system-registry",
        "namespace": "ugence_ai_system_registry",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_ai_system_registry",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_ai_system_registry.__all__). tests/packaging/test_packaging.py asserts "
