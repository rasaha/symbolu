...
caller input, so an export is a pure function of what it was given and two
exports of the same clearance are byte-identical.
"""
...
def iso(value: datetime, name: str = "instant") -> str:
    """Canonical UTC ISO-8601 text with microseconds, suitable for transport and ordering."""
...
def domain_digest(domain: str, value: Any) -> str:
    ...
    preimage = f"{_NAMESPACE}{_US}{domain}{_US}v1{_US}{canonical_json(value)}"
