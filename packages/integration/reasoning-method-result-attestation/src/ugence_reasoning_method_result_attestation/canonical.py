...
spelling this repository's signed contracts use. A second spelling is a
...
def require_string_mapping(name: str, value: Any) -> dict:
    ...
    This is the discipline a signed mapping is
    ...
    is forbidden to add (SCR-1: wrapper, not modification).
    """
