"""pytest fixtures and the property-category ledger for the Phase 5C suite."""

from __future__ import annotations

import pytest

from _admission_fixtures import World, build_admission_world


@pytest.fixture
def world() -> World:
    return build_admission_world()
