...
import ugence_cloud_scaling_action_admission as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-cloud-scaling-action-admission",
        "namespace": "ugence_cloud_scaling_action_admission",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_cloud_scaling_action_admission",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_cloud_scaling_action_admission.__all__). tests/packaging/test_packaging.py "
