...
def build() -> dict:
    return {
        "distribution": "ugence-risk-authority-effect-attestation",
        "namespace": "ugence_risk_authority_effect_attestation",
        "package_version": pkg.__version__,
        "maturity": pkg.MATURITY,
        "curated_api_module": "ugence_risk_authority_effect_attestation",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_risk_authority_effect_attestation.__all__). tests/packaging/test_packaging.py "
