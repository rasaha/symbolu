...
import ugence_incident_response as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-incident-response",
        "namespace": "ugence_incident_response",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_incident_response",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_incident_response.__all__). tests/packaging/test_packaging.py asserts "
