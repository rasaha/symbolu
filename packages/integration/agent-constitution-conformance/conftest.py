...
resolution through the real pipeline: a resolver proven against a hand-rolled
stub core would prove nothing about the authority it exists to call.
"""
...
if REPO is not None:
    ...
    _SRC_PATHS += (
        ...
        PACKAGES / "jcs" / "src",
        # The family this distribution resolves and verifies against.
