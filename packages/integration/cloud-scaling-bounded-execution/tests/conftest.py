"""pytest fixtures and the property-category ledger for the Phase 5D suite."""

from __future__ import annotations

import pytest

from _execution_fixtures import World, build_execution_world


@pytest.fixture
def world() -> World:
    return build_execution_world()
...
MODULE_PROPERTY_CATEGORY = {
    ...
    "test_live_gating": "adversarial",
    "test_no_credential_material": "adversarial",
