...
import ugence_agent_assurance_evidence as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-agent-assurance-evidence",
        "namespace": "ugence_agent_assurance_evidence",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_agent_assurance_evidence",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_agent_assurance_evidence.__all__). tests/packaging/test_packaging.py asserts "
