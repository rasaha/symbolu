...
**119 authority-bearing guards.** A guard is an `if` whose body can reach a
...
a stylistic choice — a raise-only reading of this package would miss 49 of the guards below.
...
**10 `EXCLUDED`**, each with a reason from a closed vocabulary and
...
| 35 | `verified.py:488` | raising-helper call | SCORED | — | `self.candidate_digest_fact is not None` |
| 36 | `verified.py:495` | raise | SCORED | — | `self.capacity_bounds_fact is not None` |
| 37 | `verified.py:496` | raise | SCORED | — | `type(self.capacity_bounds_fact) is not tuple` |
| 38 | `verified.py:501` | raise | SCORED | — | `not self.capacity_bounds_fact` |
| 39 | `verified.py:508` | raise | SCORED | — | `type(bound) is not VerifiedCapacityBound` |
...
| 55 | `verification.py:195` | raise | SCORED | — | `self.verified_policy is not None` |
| 56 | `verification.py:196` | raise | SCORED | — | `type(self.verified_policy) is not VerifiedPolicyAuthenticity` |
| 57 | `verification.py:207` | raise | SCORED | — | `type(self.resolution) is not PolicyResolution` |
| 58 | `verification.py:214` | raise | SCORED | — | `self.refusal is not None and type(self.refusal) is not PolicyAuthenticityRe…` |
| 59 | `verification.py:240` | raise | SCORED | — | `resolution.requested_coordinate != coordinate` |
| 60 | `verification.py:247` | raise | SCORED | — | `type(record) is not IssuedPolicyRecord or record.coordinate != coordinate` |
...
| 68 | `verification.py:412` | typed-refusal call | SCORED | — | `type(coordinate) is not PolicyCoordinate` |
| 69 | `verification.py:419` | typed-refusal call | SCORED | — | `type(expected_reference_tenant_id) is not str` |
| 70 | `verification.py:424` | typed-refusal call | SCORED | — | `type(as_of) is not datetime or as_of.tzinfo is None or as_of.utcoffset() is…` |
| 71 | `verification.py:430` | typed-refusal call | SCORED | — | `candidate is not None and type(candidate) is not CapacityAuthorizationCandi…` |
| 72 | `verification.py:440` | typed-refusal call | SCORED | — | `expected_reference_tenant_id != coordinate.tenant_id` |
| 73 | `verification.py:460` | typed-refusal call | SCORED | — | `type(resolution) is not PolicyResolution` |
...
| 82 | `verification.py:519` | typed-refusal call | SCORED | — | `record.coordinate.content_digest != record.policy_body_digest` |
| 83 | `verification.py:529` | typed-refusal call | SCORED | — | `record.signature_alg not in SUPPORTED_SIGNATURE_ALGORITHMS` |
| 84 | `verification.py:536` | typed-refusal call | SCORED | — | `not is_policy_digest(record.policy_body_digest)` |
| 85 | `verification.py:541` | typed-refusal call | SCORED | — | `candidate is not None and (not is_phase5a_digest(candidate.candidate_digest))` |
| 86 | `verification.py:551` | typed-refusal call | SCORED | — | `candidate is not None` |
| 87 | `verification.py:553` | typed-refusal call | SCORED | — | `mismatch is not None` |
| 88 | `verification.py:566` | typed-refusal call | SCORED | — | `candidate is not None` |
| 89 | `verification.py:568` | typed-refusal call | SCORED | — | `crossing is not None` |
| 90 | `verification.py:577` | typed-refusal call | SCORED | — | `candidate is not None` |
| 91 | `verification.py:584` | typed-refusal call | SCORED | — | `mistyped is not None` |
| 92 | `verification.py:588` | typed-refusal call | SCORED | — | `staleness is not None` |
...
| 109 | `verification.py:852` | typed-refusal tuple | SCORED | — | `not matches` |
| 110 | `verification.py:864` | typed-refusal tuple | SCORED | — | `len(matches) > 1` |
| 111 | `verification.py:884` | typed-refusal tuple | SCORED | — | `type(carried) is not int or isinstance(carried, bool)` |
| 112 | `verification.py:890` | typed-refusal tuple | SCORED | — | `carried > authenticated` |
| 113 | `verification.py:1026` | typed-refusal tuple | SCORED | — | `type(value) is not datetime` |
| 114 | `verification.py:1053` | typed-refusal tuple | SCORED | — | `instant < valid_from` |
| 115 | `verification.py:1059` | typed-refusal tuple | SCORED | — | `instant > valid_until` |
| 116 | `verification.py:1067` | typed-refusal tuple | SCORED | — | `instant > expires_at` |
| 117 | `verification.py:1076` | typed-refusal tuple | SCORED | — | `instant < occurred_at` |
| 118 | `verification.py:1101` | outcome selection | SCORED | — | `isinstance(exc, _PackageError)` |
| 119 | `verification.py:1102` | returned outcome | SCORED | — | `type(outcome) is not _Outcome or outcome is _Outcome.VERIFIED` |
