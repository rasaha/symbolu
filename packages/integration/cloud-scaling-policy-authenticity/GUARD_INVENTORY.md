...
**117 authority-bearing guards.** A guard is an `if` whose body can reach a
...
a stylistic choice — a raise-only reading of this package would miss 47 of the guards below.
