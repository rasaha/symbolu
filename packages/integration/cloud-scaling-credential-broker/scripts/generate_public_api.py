...
import ugence_cloud_scaling_credential_broker as pkg  # noqa: E402
...
def build() -> dict:
    return {
        "distribution": "ugence-cloud-scaling-credential-broker",
        "namespace": "ugence_cloud_scaling_credential_broker",
        "package_version": pkg.__version__,
        "curated_api_module": "ugence_cloud_scaling_credential_broker",
        "note": (
            "Machine-readable snapshot of the curated public API "
            "(ugence_cloud_scaling_credential_broker.__all__). tests/packaging/test_packaging.py "
