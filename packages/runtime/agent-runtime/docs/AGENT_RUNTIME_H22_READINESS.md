...
distributed transaction is claimed. Maturity `IMPLEMENTED_AND_CI_VERIFIED` — scoped
`agent-runtime-ci` (package suite, isolated wheel-install, platform-freeze) plus terminology,
