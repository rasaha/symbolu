...
Allows the package-local suite to run standalone (``pytest packages/.../tests``) or from
an installed wheel, without an editable install.
"""
...
try:  # pragma: no cover - environment dependent
    import ugence_llm_steering_controller  # noqa: F401
