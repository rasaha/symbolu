...
Usage:
    python -m ugence_cloud_scaling_controller.main --config /etc/ncc/controller.yaml
    python -m ugence_cloud_scaling_controller.main --dry-run          # defaults, no scaling
    python -m ugence_cloud_scaling_controller.main --shadow           # shadow mode vs HPA
"""
...
from ugence_cloud_scaling_controller.observability.metrics_server import MetricsServerConfig
from ugence_cloud_scaling_controller.observability.otel_exporter import OtelExporterConfig
from ugence_cloud_scaling_controller.orchestrator import (
    OrchestratorConfig,
...
from ugence_cloud_scaling_controller.recommend.engine import RecommendConfig
...
from ugence_cloud_scaling_controller.action.k8s_actuator import ActuatorConfig, ActuatorMode
from ugence_cloud_scaling_controller.action.feedback import FeedbackConfig
...
def _run_shadow(config: Dict[str, Any], args: argparse.Namespace) -> None:
    ...
    from ugence_cloud_scaling_controller.shadow.runner import ShadowConfig, ShadowRunner
