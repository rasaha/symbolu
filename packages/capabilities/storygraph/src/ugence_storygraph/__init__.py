...
# Contract/compat metadata for the canonical package (additive; see version.py).
CONTRACT_VERSION = "2.0.0"
COMPATIBLE_LEGACY_NAMESPACE = "composite_threat_detector"
...
# Curated small public API surface (see api.py). Importing it is additive and
# does not alter any symbol above; every name it exposes is the SAME object.
