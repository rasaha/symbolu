...
import ugence_storygraph as _usg
import ugence_storygraph.policypack as _pp

HERE = os.path.dirname(os.path.abspath(__file__))
_PKG_DIR = os.path.dirname(_usg.__file__)
INTAKE = os.path.join(_PKG_DIR, "replay_intake")
FIXTURE = os.path.join(os.path.dirname(_pp.__file__), "fixtures",
...
def test_finding_digest_changes_if_matcher_version_changes(monkeypatch):
    ...
    import ugence_storygraph.storygraph as SG
