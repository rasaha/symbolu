...
| Reasoning-method fit, and whether an advisory may leave research | Reasoning Method Advisor (`admit`); this package records the admitted reference as typed input, never as authority (`RM-3`, 0.5.0) |
