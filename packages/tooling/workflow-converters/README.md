...
| BPMN 2.0 | next | declarative XML; no agent semantics to invent |
...
Not JSON (YAML, code, archives), not an object, not an n8n export, over 1 MiB, deeper
than 32 levels, more than 200 nodes, or any secret-shaped key or value anywhere in
the export. A refusal writes nothing.
