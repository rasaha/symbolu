...
from ugence_decision_authority.actions.control_plane import ActionControlPlanePort
from ugence_decision_authority.decisions import DecisionOutcome, ProposedOutcome
from ugence_decision_authority.execution.external_system import ExternalExecutionPort
from ugence_decision_authority.ports.linked_record import LinkedRecordPort

from ugence_procurement.actions import all_mappings
from ugence_procurement.approvals import (
    PurchaseApproval,
    PurchaseRecommendation,
    decision_outcome_for,
    proposed_outcome_for,
)
from ugence_procurement.errors import PurchaseRequestValidationError
from ugence_procurement.policies import AssessmentStatus, BudgetAuthorityAdapter
from ugence_procurement.suppliers import SupplierExecutionAdapter
from ugence_procurement.requests import PurchaseItem, PurchaseRequest, SupplierReference
from ugence_procurement.requests import BudgetReference
...
def test_purchase_request_rejects_empty_items():
    from ugence_decision_authority.errors import DomainValidationError
...
def _linked_adapter():
    from ugence_procurement.adapters import ProcurementAssessmentLinkedRecordAdapter
    from ugence_procurement.policies import InMemoryProcurementAssessmentRepository
