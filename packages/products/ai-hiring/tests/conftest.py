...
from ugence_ai_hiring import HiringPlatform, build_in_memory_platform
from ugence_ai_hiring.domain.enums import (
    CapabilityLayer,
    ConfidenceLevel,
    EvaluationStatus,
)
from ugence_ai_hiring.domain.evaluation import (
    CandidateEvaluation,
    EvidenceRef,
    Gap,
    LayerScore,
...
from ugence_ai_hiring.policies.decision_boundary import StaticIdentityProvider
...
# --------------------------------------------------------------------------
from ugence_ai_hiring.normalization.models import EvidenceFormat as _EvidenceFormat
from ugence_ai_hiring.normalization.models import RawSubmission as _RawSubmission
...
# --------------------------------------------------------------------------
from ugence_ai_hiring.assessments.status import SupplierType as _SupplierType
...
# --------------------------------------------------------------------------
from ugence_ai_hiring.action_requests import ActionMapping, ActionMappingStatus, ParameterSchema
...
from ugence_ai_hiring.ontology.taxonomy import ReasonCode as _ReasonCode
