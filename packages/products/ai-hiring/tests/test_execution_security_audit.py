...
from ugence_ai_hiring.api.execution_routes import (
...
from ugence_ai_hiring.errors import ExecutionAuthorizationError, ExecutionIntentNotFoundError
from ugence_ai_hiring.executions import BusinessOutcome, Finality, OutcomeSource
...
def test_domain_depends_on_port_not_vendor_sdk():
    ...
    import ugence_ai_hiring.services.execution_service as svc
