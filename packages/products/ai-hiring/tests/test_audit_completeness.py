...
from ugence_ai_hiring.domain.enums import AuditEventType as E
from ugence_ai_hiring.errors import ContentExtractionError, EmptyExtractionError
...
def test_ingestion_completed_state_recorded(platform):
    ...
    from ugence_ai_hiring.normalization.models import IngestionState
