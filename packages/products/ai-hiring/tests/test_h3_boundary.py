...
`ugence_decision_authority.api`, never imports ActionGate / action-request / execution
...
H3_MODULES = [
    "ugence_ai_hiring/governance/binding.py", "ugence_ai_hiring/governance/outcomes.py",
    "ugence_ai_hiring/governance/linked_record.py", "ugence_ai_hiring/governance/reconstruction.py",
    "ugence_ai_hiring/governance/views.py",
    "ugence_ai_hiring/repositories/governance_repositories.py",
    "ugence_ai_hiring/services/governance_integration_service.py",
    "ugence_ai_hiring/api/governance_contracts.py",
]
