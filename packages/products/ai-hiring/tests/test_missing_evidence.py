...
from ugence_ai_hiring.assessments.status import CompletenessStatus
from ugence_ai_hiring.ontology import EvidenceType
from ugence_ai_hiring.ontology.taxonomy import ReasonCode
from ugence_ai_hiring.rubrics.evidence_rules import MissingEvidenceStatus
...
def test_missing_evidence_for_unknown_criterion_is_refused(assessment_platform):
    from ugence_ai_hiring.errors import AssessmentError
    ws = _workspace(assessment_platform)
