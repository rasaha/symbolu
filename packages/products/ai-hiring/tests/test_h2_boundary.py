...
from ugence_ai_hiring.recommendations.recommendation import HiringRecommendation, RecommendationOutcome
from ugence_ai_hiring.recommendations.status import (
...
H2_MODULES = [
    "ugence_ai_hiring/recommendations/status.py", "ugence_ai_hiring/recommendations/claim.py",
    "ugence_ai_hiring/recommendations/recommendation.py", "ugence_ai_hiring/recommendations/generator.py",
    "ugence_ai_hiring/recommendations/tap_integration.py", "ugence_ai_hiring/recommendations/review.py",
    "ugence_ai_hiring/synthesis/package.py", "ugence_ai_hiring/synthesis/minimization.py",
    "ugence_ai_hiring/synthesis/service.py",
    "ugence_ai_hiring/repositories/recommendation_repositories.py",
    "ugence_ai_hiring/services/recommendation_generation_service.py",
    "ugence_ai_hiring/services/recommendation_reconstruction_service.py",
    "ugence_ai_hiring/api/recommendation_contracts.py",
]
...
def test_h2_core_imports_only_public_surfaces():
    """H2 modules may import ugence_decision_authority and ugence_governance_provider_framework only via
