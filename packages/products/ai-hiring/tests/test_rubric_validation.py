...
from ugence_ai_hiring.ontology import EvidenceType, ReasonCode
from ugence_ai_hiring.rubrics import EvidenceRule, Rubric, RubricCapability
from ugence_ai_hiring.services.rubric_validation_service import IssueCode
...
def test_unpublished_capability(platform):
    ...
    from ugence_ai_hiring.ontology import CapabilityStatus
...
def test_custom_scale_recognized(platform):
    publish_capability(platform, "cap.python")
    from ugence_ai_hiring.rubrics import ScoringScale, ScaleType
