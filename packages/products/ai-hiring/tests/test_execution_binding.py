...
from ugence_ai_hiring.action_requests import AuthorizationOutcome, OfflineDeterministicControlPlane
...
from ugence_ai_hiring.executions import ExecutionStatus
...
def _authorized_with_clocks(platform, *, authz_validity, cer_validity, anchor):
    ...
    from ugence_ai_hiring.action_requests import OfflineDeterministicControlPlane
    from ugence_ai_hiring.services.action_authorization_service import ActionAuthorizationService
...
def test_expired_authorization_blocks_execution(execution_platform):
    ...
    from ugence_ai_hiring.services.execution_service import ExecutionService
...
def test_cross_tenant_intent_creation_is_denied(execution_platform):
    ...
    from ugence_ai_hiring.errors import ExecutionAuthorizationError
