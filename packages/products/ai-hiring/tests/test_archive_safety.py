...
from ugence_ai_hiring.errors import ArchiveSafetyError, ContentExtractionError
from ugence_ai_hiring.normalization.archive_safety import inspect_archive
...
def test_oversized_xml_read_blocked():
    from ugence_ai_hiring.normalization.archive_safety import read_entry_bounded
