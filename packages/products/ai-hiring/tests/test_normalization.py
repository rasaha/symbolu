...
from ugence_ai_hiring.normalization.cleaners import NormalizationProfile, normalize_text
from ugence_ai_hiring.normalization.hashing import normalized_hash, raw_hash
...
def test_invalid_utf_is_repaired_not_fatal():
    from ugence_ai_hiring.normalization.cleaners import decode_bytes
