...
# now live in ``ugence_decision_authority.vocabulary`` and are re-exported here so the
# historical ``ugence_ai_hiring.ontology.taxonomy`` import path is unchanged.
from ugence_decision_authority.api.vocabulary import (  # noqa: E402,F401
    REASON_CODE_CATALOG,
    ReasonCode,
    ReasonCodeSpec,
