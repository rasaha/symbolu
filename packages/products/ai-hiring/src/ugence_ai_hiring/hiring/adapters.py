...
The implementation lives physically under ``ugence_ai_hiring.adapters`` (retained for
...
from ugence_ai_hiring.adapters.linked_records import HiringAssessmentLinkedRecordAdapter
