...
from ai_hiring.errors import DuplicateEvidenceError
from ai_hiring.policies.duplicate_policy import DuplicateClassification
...
def test_policy_cross_tenant_not_disclosed():
    from ai_hiring.policies.duplicate_policy import (
