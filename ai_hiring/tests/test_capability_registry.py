...
from ai_hiring.errors import CapabilityNotFoundError, OntologyError, VersionConflictError
from ai_hiring.ontology import Capability, CapabilityStatus, EvidenceType
