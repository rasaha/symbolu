...
from ai_hiring.errors import ContentExtractionError, StructuredLimitError
from ai_hiring.normalization.limits import EvidenceLimits
from ai_hiring.normalization.structured_limits import (
    check_csv_bounded,
    parse_json_bounded,
)
...
def test_structured_limit_failure_leaves_no_evidence(platform):
    ...
    from ai_hiring.services import EvidenceIngestionService
