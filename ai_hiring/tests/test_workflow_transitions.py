...
from ai_hiring.domain.enums import ActorType, AuditEventType, WorkflowState
...
from ai_hiring.policies import transition_policy as tp
...
def test_blocked_evaluation_cannot_enter_review(platform):
    _init(platform)
    _advance_to(platform, "cand-1", S.EVALUATED)
    from ai_hiring.domain.enums import EvaluationStatus
...
def test_disposition_to_state_mapping():
    from ai_hiring.domain.enums import Disposition
