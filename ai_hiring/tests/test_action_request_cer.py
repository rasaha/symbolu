...
from ai_hiring.action_requests import ActionRequestStatus
from ai_hiring.common import utc_now
from ai_hiring.errors import ActionRequestNotReadyError, ProhibitedActionParameterError
...
def test_cer_expiration_is_enforced(action_platform):
    ...
    from ai_hiring.errors import CERExpiredError
