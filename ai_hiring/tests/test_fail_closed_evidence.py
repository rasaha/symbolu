...
from ai_hiring.errors import EmptyExtractionError
from ai_hiring.index.interfaces import SearchQuery
from ai_hiring.normalization.eligibility import EligibilityReason
...
def test_eligibility_policy_blocks_on_empty():
    from ai_hiring.normalization.eligibility import (
        DEFAULT_ELIGIBILITY_POLICY,
        EligibilityInput,
    )
    from ai_hiring.normalization.extraction_status import ExtractionStatus
