...
from ai_hiring.governance.binding import GovernanceBindingStatus
...
def test_open_case_requires_review_bound_recommendation():
    ...
    from ai_hiring.tests.h2_helpers import application_in_assessment, evaluator, generator, provider
    gen = ai_ctx()
