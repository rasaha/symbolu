...
from ..action_requests.status import AUTHORIZED_STATUSES, AuthorizationOutcome
...
from ..executions.external_system import ExternalExecutionPort
from ..executions.lifecycle import is_legal_transition
