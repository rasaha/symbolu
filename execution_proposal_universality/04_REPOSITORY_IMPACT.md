...
| `acp/END_TO_END_CONTROL_PLANE_SPEC.md` "LLM stage (reader)" | the pipeline has a single reader slot | **Generalizes** — the "reader" slot becomes "any runtime + adapter." The slot stays; its sole-occupant assumption goes. |
