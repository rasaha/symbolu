...
class RecordType(str, Enum):
    ...
    PILOT_STUDY_MANIFEST = "PILOT_STUDY_MANIFEST"
    PILOT_PREPILOT_FREEZE = "PILOT_PREPILOT_FREEZE"
    PILOT_AMENDMENT = "PILOT_AMENDMENT"
    PILOT_CANDIDATE_SELECTION = "PILOT_CANDIDATE_SELECTION"
    PILOT_EVALUATION_ANNOTATION = "PILOT_EVALUATION_ANNOTATION"
    PILOT_CHECKPOINT = "PILOT_CHECKPOINT"
    PILOT_ADVERSE_CASE = "PILOT_ADVERSE_CASE"
    PILOT_CALIBRATION_RECOMMENDATION = "PILOT_CALIBRATION_RECOMMENDATION"
    PILOT_READINESS_VERDICT = "PILOT_READINESS_VERDICT"
    PILOT_EVIDENCE_PACK = "PILOT_EVIDENCE_PACK"
...
class WorkflowEventType(str, Enum):
    ...
    # MVP 1F — pilot study audit events
    PILOT_STUDY_EVENT = "PILOT_STUDY_EVENT"
