...
class RecordType(str, Enum):
    ...
    ENTERPRISE_SNAPSHOT_PROJECTION = "ENTERPRISE_SNAPSHOT_PROJECTION"
    PILOT_EVALUATION_RECORD = "PILOT_EVALUATION_RECORD"
    PILOT_REVIEWER_FEEDBACK = "PILOT_REVIEWER_FEEDBACK"
    PILOT_METRICS_SNAPSHOT = "PILOT_METRICS_SNAPSHOT"
    PILOT_REPORT = "PILOT_REPORT"
    # MVP 1E — deployable pilot operator
    PILOT_DEPLOYMENT_CONFIG = "PILOT_DEPLOYMENT_CONFIG"
    PILOT_RUN_RECORD = "PILOT_RUN_RECORD"
    PILOT_LIFECYCLE_EVENT = "PILOT_LIFECYCLE_EVENT"
    PILOT_SECURITY_EVENT = "PILOT_SECURITY_EVENT"
    PILOT_KILL_SWITCH_STATE = "PILOT_KILL_SWITCH_STATE"
    REVIEWER_QUEUE_ITEM = "REVIEWER_QUEUE_ITEM"
    PILOT_OPERATOR_METRICS = "PILOT_OPERATOR_METRICS"
...
class WorkflowEventType(str, Enum):
    ...
    # MVP 1D — pilot audit journal events
    PILOT_STAGE_COMMITTED = "PILOT_STAGE_COMMITTED"
    # MVP 1E — pilot operator audit events
    PILOT_OPERATOR_EVENT = "PILOT_OPERATOR_EVENT"
