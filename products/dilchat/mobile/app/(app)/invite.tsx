...
/**
 * Create a partner invitation. The token is shown for the user to share; it is
 * never written to logs. Neutral wording only — no relationship framing.
 */
export default function Invite(): React.ReactElement {
  ...
  return (
    <Screen>
      ...
      <Body muted>
        Create an invitation and share the code with the person you want to connect with. They enter it in their own
        account to connect.
      </Body>
      ...
      {invitation ? (
        <Card>
          ...
          <Body muted>
            Share this code directly with your partner through a channel you trust. Anyone with the code can use it to
            connect, so share it only with that person.
          </Body>
        </Card>
      ) : (
