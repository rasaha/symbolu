...
class ErrorCode(str, enum.Enum):
    ...
    MISSING_APPROXIMATION_INTERVAL = "MISSING_APPROXIMATION_INTERVAL"
    # Astrology
    EPHEMERIS_UNAVAILABLE = "EPHEMERIS_UNAVAILABLE"
    PROVIDER_DISABLED = "PROVIDER_DISABLED"
    PROVIDER_NOT_PERMITTED = "PROVIDER_NOT_PERMITTED"
    SYNTHETIC_PERSIST_FORBIDDEN = "SYNTHETIC_PERSIST_FORBIDDEN"
...
_STATUS_BY_CODE: dict[ErrorCode, int] = {
    ...
    ErrorCode.CONVERSATION_NOT_ACTIVE: 409,
    ...
    ErrorCode.MISSING_APPROXIMATION_INTERVAL: 422,
    ErrorCode.EPHEMERIS_UNAVAILABLE: 503,
    ErrorCode.PROVIDER_DISABLED: 503,
    ErrorCode.PROVIDER_NOT_PERMITTED: 503,
    ErrorCode.SYNTHETIC_PERSIST_FORBIDDEN: 409,
    ErrorCode.UNCERTAIN_CLASSIFICATION: 422,
