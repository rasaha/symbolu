"""Verification guard (Phase 1). Fails on drift of ANY prior outcome-bearing artifact this shadow
pilot must not modify: AGE, AssertionGate robustness, EvidenceAssurance, ClaimIntegrity, and
ScopeIntegrity (corpora + frozen eval outputs). The pilot uses all components READ-ONLY through
adapters; it modifies no frozen logic or artifact. Run in CI/tests before any outcome-bearing eval.
"""
