...
APPROVED_EVIDENCE_PATHS = (
    "cyber_security/composite_threat_detector/evaluation/evidence/*",
    "cyber_security/composite_threat_detector/evaluation/results/*_evidence_record.json",
    "cyber_security/composite_threat_detector/*_EVIDENCE_*.md",
    "cyber_security/composite_threat_detector/STORY_GRAPH_EVIDENCE_LEDGER.md",
)
